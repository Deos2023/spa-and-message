...
export default function Navbar() {
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav className="w-full flex items-center justify-between px-6 py-4  bg-white fixed top-0 z-50">
        ...
        <div 
          ...
          className="text-4xl font-bold text-[#5E3B1F] px-6 sm:ml-20 py-2 rounded-full  shadow-md"
        >
          Spa & Massage
        </div>
          ...
          <div className="absolute top-full left-0 w-full bg-white shadow-lg py-4 px-6">
            {['Home', 'Services', 'About', 'Gallery', 'Contact'].map((item) => (
              <a 
                key={item}
                href="/"
                className="block py-3 text-[#5E3B1F] font-medium border-b border-[#f0e6d9] hover:text-[#27A4A1]"
