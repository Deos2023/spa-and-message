...
export default function ServicesPage() {
  ...
  const massageServices = [
    { 
      ...
      price: "₹1499", 
      duration: "60 mins",
      description: "Relaxing massage with aromatic essential oils to relieve stress and improve circulation"
    },
    { 
      name: "Dry Massage", 
      price: "₹1199", 
      duration: "45 mins",
      description: "Traditional massage technique without oils to improve muscle tone and flexibility"
    },
    { 
    ...
    <div className="bg-white">
      ...
      <section className="py-16 px-4 bg-[#f8f3ed]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {spaBeautyServices.map((service, index) => (
              <ServiceCard key={index} service={service} />
            ))}
          </div>
        </div>
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
      <div className="h-48 bg-[#A06718] flex items-center justify-center relative overflow-hidden">
        <Image 
          src={`/spa/${service.name.toLowerCase().replace(/\s+/g, '-')}.png`}
          alt={service.name}
          fill
      ...
      <div className="p-6">
        ...
        <a 
          href={`https://wa.me/919123071634?text=Hi,%20I%20would%20like%20to%20book%20${service.name}%20service`}
          target="_blank"
